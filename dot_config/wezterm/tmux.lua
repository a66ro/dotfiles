...
-- ============================================
local projects_dir = wezterm.home_dir .. '/.config/wezterm/wezterm-projects'
...
M.keys = {
  ...
  { key = 'h', mods = 'ALT', action = act.ActivateTabRelative(1) },                -- next tab
  { key = 'l', mods = 'ALT', action = act.ActivateTabRelative(-1) },               -- previous tab
