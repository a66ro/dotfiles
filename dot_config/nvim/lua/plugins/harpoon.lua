...
vim.keymap.set('n', '<leader>ma', miniharp.toggle_file, { desc = '[A]dd file to list' })
vim.keymap.set('n', '<C-n>', miniharp.next, { desc = '' })
vim.keymap.set('n', '<C-p>', miniharp.prev, { desc = '' })
vim.keymap.set('n', '<leader>ml', miniharp.show_list, { desc = '[l]ist' })
-- vim.keymap.set('n', '<leader>mL', ,  { desc =  '[L]ist enter'})
